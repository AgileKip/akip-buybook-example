package org.agilekip.tutorials.buybook.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.agilekip.tutorials.buybook.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.agilekip.tutorials.buybook.repository.UserRepository.USERS_BY_EMAIL_CACHE);
